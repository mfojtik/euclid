...
<div class="container-fluid">
        ...
        <div class="col">
            <table class="table border table-striped-columns">
                ...
                <tr>
                    ...
                    <td style="width:33%" class="text-md-end">{{.SolarToday}}</td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td style="width:33%" class="text-md-end">{{.SolarTotal}}</td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td style="width:33%" class="text-md-end">{{.SolarNow}}</td>
                </tr>
                <tr>
                    <th scope="row">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plug" viewBox="0 0 16 16">
                    ...
                    <td style="width:33%" class="text-md-end">{{.EnergyToday}}</td>
                </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="row" style="padding-top: 30px;">
        <div class="col">
            <table class="table border table-striped-columns">
                <tbody>
                <tr>
                    <th scope="row">Outdoor Humidity</th>
                    <td class="w-25 text-md-end">
                        80%
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16">
                ...
                <tr>
                    <th scope="row">Living Room Humidity</th>
                    <td class="w-25 text-md-end">
                        45%
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1"/>
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-md-end"><small>Last Update:<br/>{{.LastUpdate}}</small></div>
    </div>
</div>
